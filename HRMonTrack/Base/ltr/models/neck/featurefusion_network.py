...
class FeatureFusionNetwork(nn.Module):
    ...
    def forward(self, src_temp, mask_temp, src_search, mask_search, pos_temp, pos_search):
        ...
        memory_temp, memory_search, attn_m1, attn_m2 = self.encoder(src1=src_temp, src2=src_search,
        ...
        return hs.unsqueeze(0).transpose(1, 2), attn_m1, attn_m2
...
class Encoder(nn.Module):
    ...
    def forward(self, src1, src2,
        ...
        attn_m2 = []
        for layer in self.layers:
            output1, output2, attn_m01, attn_m02 = layer(output1, output2, src1_mask=src1_mask,
                                     src2_mask=src2_mask,
            ...
            # print(' --------------------------------- shape of attn_m1:{}, attn_m2:{} --------------------------------- '.format(attn_m01.shape, attn_m02.shape))
            attn_m1.append(attn_m01)
            attn_m2.append(attn_m02)

        return output1, output2, attn_m1, attn_m2
...
class FeatureFusionLayer(nn.Module):
    ...
    def forward_post(self, src1, src2,
        ...
        src12, attn_m1 = self.multihead_attn1(query=self.with_pos_embed(src1, pos_src1),
                                   key=self.with_pos_embed(src2, pos_src2),
                                   value=src2, attn_mask=src2_mask,
                                   key_padding_mask=src2_key_padding_mask)
        src22, attn_m2 = self.multihead_attn2(query=self.with_pos_embed(src2, pos_src2),
        ...
        return src1, src2, attn_m1, attn_m2
