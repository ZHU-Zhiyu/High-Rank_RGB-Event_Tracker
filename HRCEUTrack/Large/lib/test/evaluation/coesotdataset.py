...
class COESOTDataset(BaseDataset):
    ...
    def _construct_sequence(self, sequence_name):
        ...
        # print(event_img_list)
        event_img_list = [os.path.join(event_img_path, frame) for frame in event_img_list]

        frames_event_path = '{}/{}/{}'.format('/data/zhu_19/COESOT_test_Voxel', sequence_name, sequence_name+'_voxel')
    ...
    def _get_sequence_list(self, split):
        with open('/data/zhu_19//test_list.txt') as f:
