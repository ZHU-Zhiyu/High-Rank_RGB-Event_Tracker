...
def load_network(net_path, **kwargs):
    ...
    # print(net_path)
    # net_path = '/data/zzy/Tracking_Evt_Imgs_Sin/ltr/checkpoints/ltr/transt/transt/TransT_ep0180.pth.tar'
    print('-----------------------network path-----------------:{}'.format(env_settings().network_path))
    net, _ = ltr_loading.load_network(env_settings().network_path, **kwargs)
    #  try:
    ...
    #     print('full path:{}, net_path:{}'.format(path_full,net_path))
    #     net, _ = ltr_loading.load_network(path_full, **kwargs)
    # # print('-------------------------------------net work after loading-------------------------------------:{}'.format(dir(net)))
    return net
