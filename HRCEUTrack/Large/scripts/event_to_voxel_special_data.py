...
if __name__ == '__main__':
    ...
    for videoID in range(len(video_files)):
        ...
        special_data = [
                        'dvSave-2022_01_26_20_01_46', 'dvSave-2022_03_21_16_11_40',
                        'dvSave-2022_03_21_11_09_50', 'dvSave-2022_03_21_11_12_27',
                        'dvSave-2022_03_21_11_19_37',
                        'dvSave-2022_02_25_13_21_41',
                        'dvSave-2022_02_25_13_31_18',
                        # 'dvSave-2022_02_25_13_21_41', 'dvSave-2022_02_25_13_31_18',
                        # 'dvSave-2022_03_21_11_19_37',
                        ]
                        # 'dvSave-2022_03_21_09_05_49',            #   buffer is smaller than requested size

        if foldName not in special_data:
            print("==>> pass: ", foldName)
            continue
        ...
        for FileID in tqdm(range(len(fileLIST))):
            ...
            if extension == '.aedat4':
                ...
                read_path = os.path.join(data_path, foldName, videoName)
                ...
                for frame_no in range(0, int(frame_num / dvs_img_interval) - 1):
                    ...
                    if start_idx == end_idx:
                        ...
                        scipy.io.savemat(mat_save + 'frame{:0>4d}.mat'.format(frame_no), mdict={'coor': np.zeros([10, 3]),
                                         'features': np.zeros([10, 16])})  # coor: numpy.nan;   features: numpy.nan
