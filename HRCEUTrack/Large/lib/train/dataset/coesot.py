...
class Coesot(BaseVideoDataset):
    ...
    def _get_sequence_list(self):
        with open(os.path.join('/data/zhu_19/train_list.txt')) as f:
    ...
    def _get_event_sequence_path(self, seq_id):        ## get evemts' frames
        ...
        return os.path.join('/data/zhu_19/COESOT_Voxel', self.sequence_list[seq_id], self.sequence_list[seq_id] + "_voxel")
