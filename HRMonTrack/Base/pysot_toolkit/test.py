...
def main():
    ...
    dataset_root = '/data1/zhu_19/test_data/' #Absolute path of the dataset
    net_path = '/data1/zhu_19/Ttrack/TransT-main/ltr/checkpoints/ltr/transt/transt/TransT_ep0027.pth.tar' #Absolute path of the model
