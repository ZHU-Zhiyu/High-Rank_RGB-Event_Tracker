...
class Coesot(BaseVideoDataset):
    def __init__(self, root=None, image_loader=jpeg4py_loader, split=None, seq_ids=None, data_fraction=None):
        ...
        if split is not None:
            ...
            if split == 'train':
                file_path = os.path.join(self.root[:-13], 'train_list.txt')
            elif split == 'val':
    ...
    def _get_sequence_list(self):
        with open(os.path.join(self.root[:-13], 'train_list.txt')) as f:
    ...
    def _get_event_sequence_path(self, seq_id):        ## get evemts' frames
        ...
        return os.path.join('/data1/zhu_19/COESOT/trainning_voxel', self.sequence_list[seq_id], self.sequence_list[seq_id] + "_voxel")
    ...
    def _get_event_frame(self, seq_path, frame_id):
        ...
        for f_id in frame_id:
            ...
            # if os.path.isfile(event_frame_file):
