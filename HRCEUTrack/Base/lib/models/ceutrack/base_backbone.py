...
class BaseBackbone(nn.Module):
    def __init__(self):
        ...
        # for original ViT
        self.pos_embed = None
        self.pos_embed_event = PatchEmbed_event(in_chans=190, embed_dim=768, kernel_size=5, stride=1)
        ...
        # self.pos_embed_z_event = None
        # self.pos_embed_x_event = None
    ...
    def finetune_track(self, cfg, patch_start_index=1):
        ...
        # self.pos_embed_z_event = nn.Parameter(template_patch_pos_embed)
        # self.pos_embed_x_event = nn.Parameter(search_patch_pos_embed)
    ...
    def forward_features(self, z, x, event_z, event_x):
        # N, L = event_z.shape[2], event_z.shape[3]
        event_x = self.pos_embed_event(event_x)     # B 768 256
    ...
    def forward(self, z, x, event_z, event_x, **kwargs):
        ...
        Returns:
            ...
            attn : None
        """
        x, aux_dict = self.forward_features(z, x, event_z, event_x)
